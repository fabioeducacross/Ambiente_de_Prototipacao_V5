...
## <span class="material-symbols-outlined">track_changes</span> Pontuação de Missões
...
## <span class="material-symbols-outlined">emoji_events</span> Sistema de Ranking
...
|---------|-------|---------------|-------------------|-------------|---------------|
| 1º <span class="material-symbols-outlined">workspace_premium</span> | Maria | 580 | 6 | 12min | 05/02/2026 |
| 2º <span class="material-symbols-outlined">workspace_premium</span> | João | 580 | 6 | 15min | 04/02/2026 |
| 3º <span class="material-symbols-outlined">workspace_premium</span> | Ana | 550 | 6 | 10min | 03/02/2026 |
...
## <span class="material-symbols-outlined">bar_chart</span> Progresso e Médias
...
## <span class="material-symbols-outlined">school</span> Taxa de Acertos por Habilidade
...
|--------|-------------------|---------|-------|
| Missão 1 | Q1, Q3 | Q1 <span class="material-symbols-outlined">check_circle</span> | Q3 <span class="material-symbols-outlined">cancel</span> |
| Missão 2 | Q2, Q5 | Q2 <span class="material-symbols-outlined">check_circle</span>, Q5 <span class="material-symbols-outlined">check_circle</span> | - |
| Missão 3 | Q4 | Q4 <span class="material-symbols-outlined">check_circle</span> | - |
...
## <span class="material-symbols-outlined">timer</span> Tempo Médio de Conclusão
...
## <span class="material-symbols-outlined">trending_up</span> Taxa de Participação
...
## <span class="material-symbols-outlined">military_tech</span> Sistema de Medalhas

### Critérios de Medalhas

| Medalha | Critério | Cálculo | Frequência |
|---------|----------|---------|------------|
| <span class="material-symbols-outlined">workspace_premium</span> **Mestre da Semana** | Mais pontos em 7 dias | MAX(pontos) na semana | Semanal |
| <span class="material-symbols-outlined">local_fire_department</span> **Streak** | Dias consecutivos com atividade | Contagem de dias | Diária |
| <span class="material-symbols-outlined">star</span> **100% Perfeito** | 100% acertos em missão | Acertos = Total questões | Por missão |
| <span class="material-symbols-outlined">bolt</span> **Relâmpago** | Concluir missão < 5min | Tempo < 5min | Por missão |
| <span class="material-symbols-outlined">track_changes</span> **10 Missões** | Completar 10 missões | COUNT(missões) = 10 | Cumulativo |
...
## <span class="material-symbols-outlined">bar_chart</span> Relatórios - Cálculos Agregados
...
## <span class="material-symbols-outlined">pin</span> Arredondamentos e Precisão
...
## <span class="material-symbols-outlined">track_changes</span> Casos Especiais
...
- Botão "ℹ Como é calculado?" → Modal explicativo
