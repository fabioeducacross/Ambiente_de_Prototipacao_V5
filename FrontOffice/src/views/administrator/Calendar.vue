...
import calendarMockData from '@/data/calendar-mock-administrator.json'
...
onMounted(() => {
  setMockUser({
    id: 'admin-001',
    name: 'Admin. Carlos Silva',
    role: 'NETWORK_MANAGER',
    origin_level: 'NETWORK',
    network: { id: 'network-sp-001', name: 'Rede Municipal São Paulo' }
  })
})
...
const headerTitle = computed(() => {
  switch (currentView.value) {
    ...
    case 'list': return 'Agenda Administrativa'
    default: return ''
  }
})
...
const openCreateModal = () => {
  console.log('Abrir modal de criação - Administrador')
}
