...
import { EButton, EInput, ESelect, ETextarea, EFormGroup, EBadge, EDatePicker, EConfirmDialog } from '@/shared/components/base'
...
const handleSubmit = () => {
  if (validateForm()) {
    const eventPayload = {
      ...
      tipo: props.eventData?.tipo || props.eventData?.type || 'outro',
