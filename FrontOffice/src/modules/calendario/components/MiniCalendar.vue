...
import MaterialIcon from '@/shared/components/MaterialIcon.vue'
...
/* Dia selecionado (clicado): círculo sólido roxo */
.day-cell.selected {
...
/* Hoje (não selecionado): anel/borda roxa */
.day-cell.today {
...
/* Hoje E selecionado: sólido + anel duplo */
