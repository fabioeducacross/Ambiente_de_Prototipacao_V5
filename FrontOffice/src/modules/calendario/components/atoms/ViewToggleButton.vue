...
.view-toggle-button {
  ...
  font-weight: 500;
  /* Background não ativo - 16% opacidade (Figma) */
  background-color: rgba(115, 103, 240, 0.16);
  /* Texto roxo primário (Figma) */
  color: #7367f0;
  border-radius: 6px;
}
...
.view-toggle-button:hover {
  /* Hover - 20% opacidade (intermediário) */
...
/* Estado ativo - 24% opacidade (Figma) */
...
.view-toggle-button.view-toggle-active:hover {
  background-color: rgba(115, 103, 240, 0.28);
}
